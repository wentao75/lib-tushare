...
const tushareUrl = "http://api.tushare.pro"; // 增加一个 fieldNames用来给出每个字段（包括输入/输出的说明）
...
const indexMarketList = [// {code: "MSCI", name: "MSCI指数"},
{
  code: "CSI",
  name: "中证指数"
}, {
...
const apiFields = {
  stockBasic: "ts_code,symbol,name,area,industry,fullname,enname,market,exchange,curr_type,list_status,list_date,delist_date,is_hs",
  stockCompany: "ts_code,exchange,chairman,manager,secretary,reg_capital,setup_date,province,city,introduction,website,email,office,employees,main_business,business_scope",
  stockManagers: "ts_code,ann_date,name,gender,lev,title,edu,national,birthday,begin_date,end_date,resume",
  stockRewards: "ts_code,ann_date,end_date,name,title,reward,hold_vol",
  tradeCalendar: "exchange,cal_date,is_open,pretrade_date",
  newShare: "ts_code,sub_code,name,ipo_date,issue_date,amount,market_amount,price,pe,limit_amount,funds,ballot",
  ...
  dailyBasic: "ts_code,trade_date,close,turnover_rate,turnover_rate_f,volume_ratio,pe,pe_ttm,pb,ps,ps_ttm,dv_ratio,dv_ttm,total_share,float_share,free_share,total_mv,circ_mv",
  ...
  limitList: "ts_code,trade_date,name,close,pct_chg,amp,fc_ratio,fl_ratio,fd_amount,first_time,last_time,open_times,strth,limit",
  moneyFlowHSGT: "trade_date,ggt_ss,ggt_sz,hgt,sgt,north_money,south_money",
  hsgtTop10: "ts_code,trade_date,name,close,change,rank,market_type,amount,net_amount,buy,sell",
  hkHold: "code,trade_date,ts_code,name,vol,ratio,exchange",
  ggtDaily: "trade_date,buy_amount,buy_volume,sell_amount,sell_volume",
  ggtMonthly: "month,day_buy_amt,day_buy_vol,day_sell_amt,day_sell_vol,total_buy_amt,total_buy_vol,total_sell_amt,total_sell_vol",
  indexGlobal: "ts_code,trade_date,open,close,high,low,pre_close,change,pct_chg,vol,amount",
  ...
  financialIndicator: "ts_code,ann_date,end_date,eps,dt_eps,total_revenue_ps,revenue_ps,capital_rese_ps,surplus_rese_ps,undist_profit_ps,extra_item,profit_dedt,gross_margin,current_ratio,quick_ratio,cash_ratio,invturn_days,arturn_days,inv_turn,ar_turn,ca_turn,fa_turn,assets_turn,op_income,valuechange_income,interst_income,daa,ebit,ebitda,fcff,fcfe,current_exint,noncurrent_exint,interestdebt,netdebt,tangible_asset,working_capital,networking_capital,invest_capital,retained_earnings,diluted2_eps,bps,ocfps,retainedps,cfps,ebit_ps,fcff_ps,fcfe_ps,netprofit_margin,grossprofit_margin,cogs_of_sales,expense_of_sales,profit_to_gr,saleexp_to_gr,adminexp_of_gr,finaexp_of_gr,impai_ttm,gc_of_gr,op_of_gr,ebit_of_gr,roe,roe_waa,roe_dt,roa,npta,roic,roe_yearly,roa2_yearly,roe_avg,opincome_of_ebt,investincome_of_ebt,n_op_profit_of_ebt,tax_to_ebt,dtprofit_to_profit,salescash_to_or,ocf_to_or,ocf_to_opincome,capitalized_to_da,debt_to_assets,assets_to_eqt,dp_assets_to_eqt,ca_to_assets,nca_to_assets,tbassets_to_totalassets,int_to_talcap,eqt_to_talcapital,currentdebt_to_debt,longdeb_to_debt,ocf_to_shortdebt,debt_to_eqt,eqt_to_debt,eqt_to_interestdebt,tangibleasset_to_debt,tangasset_to_intdebt,tangibleasset_to_netdebt,ocf_to_debt,ocf_to_interestdebt,ocf_to_netdebt,ebit_to_interest,longdebt_to_workingcapital,ebitda_to_debt,turn_days,roa_yearly,roa_dp,fixed_assets,profit_prefin_exp,non_op_profit,op_to_ebt,nop_to_ebt,ocf_to_profit,cash_to_liqdebt,cash_to_liqdebt_withinterest,op_to_liqdebt,op_to_debt,roic_yearly,total_fa_trun,profit_to_op,q_opincome,q_investincome,q_dtprofit,q_eps,q_netprofit_margin,q_gsprofit_margin,q_exp_to_sales,q_profit_to_gr,q_saleexp_to_gr,q_adminexp_to_gr,q_finaexp_to_gr,q_impair_to_gr_ttm,q_gc_to_gr,q_op_to_gr,q_roe,q_dt_roe,q_npta,q_opincome_to_ebt,q_investincome_to_ebt,q_dtprofit_to_profit,q_salescash_to_or,q_ocf_to_sales,q_ocf_to_or,basic_eps_yoy,dt_eps_yoy,cfps_yoy,op_yoy,ebt_yoy,netprofit_yoy,dt_netprofit_yoy,ocf_yoy,roe_yoy,bps_yoy,assets_yoy,eqt_yoy,tr_yoy,or_yoy,q_gr_yoy,q_gr_qoq,q_sales_yoy,q_sales_qoq,q_op_yoy,q_op_qoq,q_profit_yoy,q_profit_qoq,q_netprofit_yoy,q_netprofit_qoq,equity_yoy,rd_exp,update_flag",
  financialMainbiz: "ts_code,end_date,bz_item,bz_sales,bz_profit,bz_cost,curr_type,update_flag",
  disclosureDate: "ts_code,ann_date,end_date,pre_date,actual_date,modify_date",
  pledgeState: "ts_code,end_date,pledge_count,unrest_pledge,rest_pledge,total_share,pledge_ratio",
  pledgeDetail: "ts_code,ann_date,holder_name,pledge_amount,start_date,end_date,is_release,release_date,pledgor,holding_amount,pledged_amount,p_total_ratio,h_total_ratio,is_buyback",
  indexBasic: "ts_code,name,fullname,market,publisher,index_type,category,base_date,base_point,list_date,weight_rule,desc,exp_date",
  indexDaily: "ts_code,trade_date,close,open,high,low,pre_close,change,pct_chg,vol,amount",
  indexWeight: "index_code,con_code,trade_date,weight",
  indexDailyBasic: "ts_code,trade_date,total_mv,float_mv,total_share,float_share,free_share,turnover_rate,turnover_rate_f,pe,pe_ttm,pb",
  indexClassify: "index_code,industry_name,level,industry_code",
  indexMember: "index_code,index_name,con_code,con_name,in_date,out_date,is_new",
  dailyInfo: "trade_date,ts_code,ts_name,com_count,total_share,float_share,total_mv,float_mv,amount,vol,trans_count,pe,tr,exchange"
...
const FLOW_CONFIG = {
  ...
  [apiNames.financialMainbiz]: {
    maxFlow: 60
  },
  [DEFAULT_FLOWCONTROL_NAME]: {
    maxFlow: 800
  }
}; // const MAX_WORKER = 20
// const MAX_FLOW = 300
...
function initFlowControl() {
  ...
  for (let api in FLOW_CONFIG) {
    if (Object.prototype.hasOwnProperty.call(FLOW_CONFIG, api)) {
      tmp[api] = new FlowControl(FLOW_CONFIG[api].maxFlow, `接口${api}流控`);
...
const flowControls = initFlowControl(); // 请求计数
...
async function queryData(api = "", params = {}, fields = "", hasMoreParams = null, moreDatas = null) {
  ...
  logger.debug("%s 发送请求，%s, %o", moment().format("h:mm:ss"), api, params);
  requestCount++; // 流控添加到axios发起时触发，流控池由api_name进行分组
  ...
  if (response && response.data && response.data.code === 0) {
    ...
    logger.debug("收到服务器响应：字段数量=%d, 数据长度=%d，是否还有更多数据：%s；请求信息 %s，%o", fields.length, items.length, hasMore, api, params);
    let data = await constructData({
      fields,
      items
    ...
    if (hasMore && hasMoreParams && _.isFunction(hasMoreParams)) {
      ...
      logger.debug("有更多数据需要获取：%o, %o, %d", params, nextParams, data && data.length); // 如果无法设置参数，会返回空，这里就不再继续获取
      ...
      if (nextParams) {
        ...
        if (moreDatas && _.isFunction(moreDatas)) {
          logger.debug("更多数据调用合并: %d && %d", data.length, moreData.length);
          data = await moreDatas(data, moreData && moreData.data);
        } else {
          logger.debug("更多数据自动合并: %d && %d", data.length, moreData.length);
          data.push(...moreData);
        }
      } else {
        hasMore = false;
  ...
  errorCount++;
  logger.error("发现错误(请求信息 %s, %o)：%s, %s", api, params, response.data.code, response.data.msg);
  throw new Error("接口返回错误[" + response.data.code + "]:" + response.data.msg);
...
async function stockBasic(exchange = "", listStatus = "L") {
  let data = await queryData(apiNames.stockBasic, {
    exchange,
...
async function stockCompany(tsCode, exchange) {
  ...
  let data = await queryData(apiNames.stockCompany, {
    ts_code: tsCode,
    exchange
...
async function stockManagers(tsCode = "", annDate = "", startDate, endDate) {
  if (_.isEmpty(tsCode) && _.isEmpty(annDate) && _.isEmpty(startDate) && _.isEmpty(endDate)) {
    return new Error("上市公司管理层参数设置错误！");
  }

  let data = await queryData(apiNames.stockManagers, {
    ts_code: tsCode,
    ann_date: annDate,
...
async function stockDaily(tsCode, startDate = "", endDate = "") {
  ...
  let data = await queryData(apiNames.daily, {
    ts_code: tsCode,
    start_date: startDate,
    end_date: endDate
  }, apiFields.daily, async (params, retData) => {
    // let endDate = ""
    if (retData && retData.length > 0) {
      let lastDate = moment(retData[retData.length - 1].trade_date, "YYYYMMDD"); // endDate =
  ...
  logger.debug(`获得日线数据 ${tsCode}, 条数=${data && data.data && data.data.length}`);
  return data && data.data; // let hasMore = true
  // let retData = []
  // while (hasMore) {
  //     let data = null
  //     // 计算下一个日期范围
...
async function indexDaily(tsCode, startDate = "", endDate = "") {
  ...
  let data = await queryData(apiNames.indexDaily, {
    ts_code: tsCode,
    start_date: startDate,
    end_date: endDate
  }, apiFields.indexDaily, async (params, retData) => {
    let endDate = "";
  ...
  logger.debug(`获得指数日线数据 ${tsCode}, 条数=${data && data.data && data.data.length}`);
  return data && data.data;
}
/**
...
async function adjustFactor(tsCode, startDate = "", endDate = "") {
  ...
  let data = await queryData(apiNames.adjustFactor, {
    ts_code: tsCode,
    start_date: startDate,
    end_date: endDate
  }, apiFields.adjustFactor, async (params, retData) => {
    // let endDate = ""
    if (retData && retData.length > 0) {
      let lastDate = moment(retData[retData.length - 1].trade_date, "YYYYMMDD"); // endDate =
...
async function suspendList(tradeDate) {
  ...
  let data = await queryData(apiNames.suspendInfo, {
...
async function dailyBasicList(tradeDate = null) {
  ...
  let data = await queryData(apiNames.dailyBasic, {
    trade_date: tradeDate
...
async function dailyBasic(tsCode, startDate = null, endDate = null) {
  ...
  let data = await queryData(apiNames.dailyBasic, {
    ...
    start_date: startDate,
    end_date: endDate
  }, apiFields.dailyBasic, async (params, retData) => {
    // let endDate = ""
    if (retData && retData.length > 0) {
      let lastDate = moment(retData[retData.length - 1].trade_date, "YYYYMMDD"); // endDate =
...
async function indexBasic(market) {
  ...
  let data = await queryData(apiNames.indexBasic, {
    market
...
async function tradeCalendar(exchange, startDate = null, endDate = null) {
  ...
  let data = await queryData(apiNames.tradeCalendar, {
    exchange,
    start_date: startDate,
    end_date: endDate
  }, apiFields.tradeCalendar, async (params, retData) => {
    if (retData && retData.length > 0) {
      let lastDate = moment(retData[retData.length - 1].cal_date, "YYYYMMDD");
      return {
        exchange,
        start_date: startDate,
        end_date: lastDate.subtract(1, "days").format("YYYYMMDD")
...
async function queryStockInfo(dataName, tsCode, startDate = null, endDate = null) {
  ...
  let apiName = queryStockInfoApiNames[dataName] || queryStockFinancialInfoApiNames[dataName];
  ...
  let returnField = isStockInfo ? stockInfoReturnDateField : stockFinancialInfoReturnDateField;
  logger.debug(`个股数据参数：${dataName}, ${tsCode}, ${isStockInfo}, ${apiName}, ${startDate}, ${endDate}, ${returnField}`);
  let data = await queryData(apiName, {
    ts_code: tsCode,
    start_date: startDate,
    end_date: endDate
  }, apiFields[apiName], async (params, retData) => {
    if (retData && retData.length > 0) {
      let lastDate = moment(retData[retData.length - 1][returnField], "YYYYMMDD");
      return {
        ts_code: tsCode,
        start_date: startDate,
        end_date: lastDate.subtract(1, "days").format("YYYYMMDD")
  ...
  return [data && data.data, // 最新日期, end_date
  data && (data.data.length > 0 ? data.data[0][returnField] : null), // 最早日期, start_date
  data && (data.data.length > 0 ? data.data[data.data.length - 1][returnField] : null)];
}
